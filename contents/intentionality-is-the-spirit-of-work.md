...
- it is the _falsification criteria_ of my aformentioned hypothesis; if a
  precise discriminant cannot be found, then it is but a mere gut feeling, and
...
I've recently came across an
[interesting piece of computing history from Simon Willison's Weblog]: a page
from an internal IBM training which says
...
all, despite its [many](https://www.youtube.com/watch?v=kSno1-xOjwI),
[_many_](https://blog.trailofbits.com/2026/01/13/lack-of-isolation-in-agentic-browsers-resurfaces-old-vulnerabilities/)
faults, computers are now capable of performing actions derived from some,
albeit _limited_, form of intelligence.
...
Natural language is imprecise[^1]; consequently, any instructions provided to
the agent will contain some gaps with respect to one's true intentions. It is
then left to the agent to make assumptions to bridge these gaps by itself.
...
[interesting piece of computing history from simon willison's weblog]: https://simonwillison.net/2025/Feb/3/a-computer-can-never-be-held-accountable/
